...
/**
 * _print - function that moves a string one place to the
...
/**
 * mul - function that multiplies a char with a string and
 * places the answer into dest
 * @n: char to be multiplied
 * @num: string tob be multiplied
...
/**
 * main - our main function to multiply two numbers
